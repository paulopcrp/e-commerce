package com.github.paulocesar.services.validation;
...
import com.github.paulocesar.resources.excessao.FieldMessage;
import com.github.paulocesar.services.validation.utils.BR;
...
public class ClienteInsertValidator implements ConstraintValidator<ClienteInsert, ClienteNewDTO> {
	...
	public boolean isValid(ClienteNewDTO objDto, ConstraintValidatorContext context) {
		...
		if (aux != null) {
			list.add(new FieldMessage("email", "E-mail já cadastrato"));
		}
